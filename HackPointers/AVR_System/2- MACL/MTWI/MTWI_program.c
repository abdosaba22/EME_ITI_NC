...
STD_error_t MTWI_stderrInit(u32 ARG_u32DataRate, u8 ARG_u8Prescalar)
{
	...
	{
		case MTWI_PRESCALER1 : TWBR = ((F_CPU/ARG_u32DataRate) - 16) / (2 * 1 ); break ;
		case MTWI_PRESCALER4 : TWBR = ((F_CPU/ARG_u32DataRate) - 16) / (2 * 4 ); break ;
		case MTWI_PRESCALER16: TWBR = ((F_CPU/ARG_u32DataRate) - 16) / (2 * 16); break ;
		case MTWI_PRESCALER64: TWBR = ((F_CPU/ARG_u32DataRate) - 16) / (2 * 64); break ;
