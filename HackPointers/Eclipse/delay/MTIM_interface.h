...
#define MTIM_CS_EXTCLK_FALLING 								6
#define MTIM_CS_EXTCLK_RISING 								7

#define MTIM_CS_T2_NO_CLOCK 								0
#define MTIM_CS_T2_PRESCALER_1 								1
#define MTIM_CS_T2_PRESCALER_8 								2
#define MTIM_CS_T2_PRESCALER_32 							3
#define MTIM_CS_T2_PRESCALER_64 							4
#define MTIM_CS_T2_PRESCALER_128 							5
#define MTIM_CS_T2_PRESCALER_256 							6
#define MTIM_CS_T2_PRESCALER_1024 							7
				
#define MTIM_MODE_T0T2_NORMAL								0
#define MTIM_MODE_T0T2_CTC									1
#define MTIM_MODE_T0T2_FASTPWM								2
#define MTIM_MODE_T0T2_PHASECORRECTPWM						3

#define MTIM_HWPIN_T0T2_DISCONNECTED						0
#define MTIM_HWPIN_T0T2_TOGGLE								1
#define MTIM_HWPIN_T0T2_CLEAR								2
#define MTIM_HWPIN_T0T2_SET									3
#define MTIM_HWPIN_T0T2_NONINVERTING_PWM					2
#define MTIM_HWPIN_T0T2_INEVERING_PWM						3
//TIMSK 				
